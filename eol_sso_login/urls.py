...
from .views import *
from .api import registration_validation, check_email, send_activation_email
...
urlpatterns = [
    ...
    url(r'^eol_sso_login/api/send_activation_email/$', send_activation_email, name="api-send_activation_email"),
